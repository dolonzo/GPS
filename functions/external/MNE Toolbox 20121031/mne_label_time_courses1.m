function [ values, times, vertices ] = mne_label_time_courses1(labelfile,stcfile)
%
...
%   Modified from mne_label_time_courses to read the label vertices as
%   1-based rather than 0-based for when stc is 1-based (DOS)
%
...
try
    lab = mne_read_label_file1(labelfile);
catch
    error(me,'%s',mne_omit_first_line(lasterr));
end
