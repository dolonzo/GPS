function [label] = mne_read_label_file1(filename)
%
% [label] = mne_read_label_file1(filename)
% 
% Reads a label file. The returned structure has the following fields
%
%     comment        comment from the first line of the label file
%     vertices       vertex indices (1 based, column 1)
%     pos            locations in meters (columns 2 - 4 divided by 1000)
%     values         values at the vertices (column 5)
%

%   Modified from mne_read_label_file to return vertices as 1 based rather
%   than zero based (DOS)
%
